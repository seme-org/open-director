...
<table>
  <tr>
    <td width="50%">
      ...
      <p><a href="https://files.seme.cc/demos/1.mp4">打开 demo 1</a></p>
    </td>
    <td width="50%">
      <video src="https://files.seme.cc/demos/2.mp4" controls muted playsinline width="100%"></video>
      <p><a href="https://files.seme.cc/demos/2.mp4">打开 demo 2</a></p>
    </td>
  </tr>
</table>

GitHub 对外部 MP4 的内嵌播放支持可能会回退为链接，所以这里同时保留了直链。
